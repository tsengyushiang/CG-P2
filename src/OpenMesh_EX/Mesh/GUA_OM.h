...
{
	OpenMesh::VPropHandleT<bool> SelectedV;
	OpenMesh::FPropHandleT<bool> SelectedF;

	OpenMesh::VPropHandleT<Tri_Mesh::VertexHandle> subVertex;

	OpenMesh::VPropHandleT<double> totalWeight;
	OpenMesh::EPropHandleT<double> weight;
	/*-------------------------------------------------*/
	OpenMesh::VPropHandleT<double> texCorX;
	OpenMesh::VPropHandleT<double> texCorY;
	OpenMesh::FPropHandleT<int> texID;
	
	OpenMesh::FPropHandleT<double> x1;
	OpenMesh::FPropHandleT<double> y1;

	OpenMesh::FPropHandleT<double> x2;
	OpenMesh::FPropHandleT<double> y2;

	OpenMesh::FPropHandleT<double> x3;
	OpenMesh::FPropHandleT<double> y3;
	/*-------------------------------------------------*/
	OpenMesh::FPropHandleT<double> R;
	OpenMesh::FPropHandleT<double> G;
	OpenMesh::FPropHandleT<double> B;
	OpenMesh::FPropHandleT<double> A;
...
public:
	...
	Tri_Mesh()
	{
		this->add_property(SelectedV);
		this->add_property(SelectedF);

		this->add_property(subVertex);

		this->add_property(totalWeight);
		this->add_property(weight);

		/*-------------------------------------*/
		this->add_property(texCorX);
		this->add_property(texCorY);
		this->add_property(texID);
		this->add_property(x1);
		this->add_property(y1);
		this->add_property(x2);
		this->add_property(y2);
		this->add_property(x3);
		this->add_property(y3);
		/*---------------------------------------*/
		this->add_property(R);
		this->add_property(G);
		this->add_property(B);
	...
	/*------------------------------------*/
	FIter SelectFace(OMT::Vector3d,bool);
	void DeleteBoundary();
	void SelectOneRing();
	...
	void CreateSubMesh();
	void drawParameterization(double,double);

	/*Scale Angle X Y reverse*/
	void parametrization(double=0.5,double=0,double=0.5,double=0.5,bool = 0);
	void BindTexture(int);
	void BindColor(double = 0, double = 0, double = 0, double = 0);
